...
(
    ...
    plantBloomPeriod      VARCHAR(16),
    plantCommonName       VARCHAR(32),
    plantDuration         VARCHAR(32),
    plantDroughtTolerance INT,
    plantGrowthHabit      VARCHAR(32),
    plantGrowthPeriod     VARCHAR(32),
    ...
    plantScientificName   VARCHAR(64),
    plantShadeTolerance   INT,
    plantToxicity         INT,
